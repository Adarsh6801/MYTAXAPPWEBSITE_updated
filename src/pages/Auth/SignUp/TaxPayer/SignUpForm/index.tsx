...
const SingUpForm = (props: ISignUpFormProps) => {
  ...
  const initialValues: ISignUpFormData = {
    ...
    mayCallDirectly: !!state?.mayCallDirectly,
    agreePrivacyPolicy: !!state?.agreePrivacyPolicy,
  };

  return (
    <div style={{ justifySelf: "flex-start" }}>
      <h2 className={styles.title}>{t("individual.sing_up.taxpayer_title")}</h2>
      <Form
        onFinish={onFinish}
        layout="vertical"
        requiredMark={false}
      ...
      >
        ...
        <Form.Item
          name="mayCallDirectly"
          valuePropName="checked"
          className={styles.checkbox}
        >
          <Checkbox className={styles.text}>
            {t("individual.sing_up.agreement_tax")}
          </Checkbox>
        </Form.Item>
